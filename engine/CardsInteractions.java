...
public class CardsInteractions {
    ...
    private void initializeCards() {
        ...
        cards.put("src/images/special-c.gif",new Card(20,"c","src/images/special-c.gif"));
        cards.put("src/images/special-d.gif",new Card(20,"d","src/images/special-d.gif"));
        cards.put("src/images/special-h.gif",new Card(20,"h","src/images/special-h.gif"));
        cards.put("src/images/special-s.gif",new Card(20,"s","src/images/special-s.gif"));
